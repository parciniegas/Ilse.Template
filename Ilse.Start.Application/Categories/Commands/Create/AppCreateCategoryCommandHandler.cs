...
{
    public async Task<OperationResult<AppCreateCategoryCommandResponse>> HandleAsync(AppCreateCategoryCommand command, CancellationToken cancellationToken = new CancellationToken())
    {
